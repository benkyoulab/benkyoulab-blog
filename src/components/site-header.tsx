  ...
  return (
    <motion.header
      ...
      className={`sticky top-0 z-50 border-b transition-colors duration-300 ${
        scrolled
          ? "border-gray-100 bg-white/85 shadow-sm backdrop-blur-md"
    ...
    >
      <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-4">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          <Link
            href="/admin"
            className="ml-2 rounded-full bg-red-600 px-5 py-2 text-sm font-medium text-white shadow-sm transition-all hover:bg-red-700 hover:shadow-md active:scale-95"
          >
            Tulis ✍️
          </Link>
        </nav>
